...
#ifndef _ov5640_sobel_HH_
#define _ov5640_sobel_HH_
...
#include "start_for_CvtColokbM.h"
#include "ov5640_sobel_AXILiteS_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_AXILITES_ADDR_WIDTH = 5,
         unsigned int C_S_AXI_AXILITES_DATA_WIDTH = 32>
struct ov5640_sobel : public sc_module {
    ...
    // Module declarations
    ov5640_sobel(sc_module_name name);
    SC_HAS_PROCESS(ov5640_sobel);
    ...
    ov5640_sobel_AXILiteS_s_axi<C_S_AXI_AXILITES_ADDR_WIDTH,C_S_AXI_AXILITES_DATA_WIDTH>* ov5640_sobel_AXILiteS_s_axi_U;
    ...
    fifo_w32_d2_A* img_0_rows_V_c21_U;
    fifo_w32_d2_A* img_0_cols_V_c22_U;
    ...
    sc_signal< sc_logic > img_0_rows_V_c21_full_n;
    sc_signal< sc_lv<32> > img_0_rows_V_c21_dout;
    sc_signal< sc_logic > img_0_rows_V_c21_empty_n;
    sc_signal< sc_logic > img_0_cols_V_c22_full_n;
    sc_signal< sc_lv<32> > img_0_cols_V_c22_dout;
    sc_signal< sc_logic > img_0_cols_V_c22_empty_n;
