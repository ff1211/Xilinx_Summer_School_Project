...
#ifndef _Block_Mat_exit49_pro_HH_
#define _Block_Mat_exit49_pro_HH_
...
struct Block_Mat_exit49_pro : public sc_module {
    ...
    sc_out< sc_lv<32> > img_3_rows_V_out_din;
    sc_in< sc_logic > img_3_rows_V_out_full_n;
    sc_out< sc_logic > img_3_rows_V_out_write;
    sc_out< sc_lv<32> > img_3_cols_V_out_din;
    sc_in< sc_logic > img_3_cols_V_out_full_n;
    sc_out< sc_logic > img_3_cols_V_out_write;


    // Module declarations
    Block_Mat_exit49_pro(sc_module_name name);
    SC_HAS_PROCESS(Block_Mat_exit49_pro);
    ...
    sc_signal< sc_logic > img_3_rows_V_out_blk_n;
    sc_signal< sc_logic > img_3_cols_V_out_blk_n;
    ...
    void thread_img_3_cols_V_out_blk_n();
    void thread_img_3_cols_V_out_din();
    void thread_img_3_cols_V_out_write();
    void thread_img_3_rows_V_out_blk_n();
    void thread_img_3_rows_V_out_din();
    void thread_img_3_rows_V_out_write();
