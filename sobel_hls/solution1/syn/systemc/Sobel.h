...
struct Sobel : public sc_module {
    ...
    sc_signal< sc_lv<32> > p_src_rows_V_read_reg_92;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<32> > p_src_cols_V_read_reg_97;
    sc_signal< sc_logic > grp_Filter2D_fu_80_ap_start;
    sc_signal< sc_logic > grp_Filter2D_fu_80_ap_done;
    sc_signal< sc_logic > grp_Filter2D_fu_80_ap_idle;
    sc_signal< sc_logic > grp_Filter2D_fu_80_ap_ready;
    sc_signal< sc_logic > grp_Filter2D_fu_80_p_src_data_stream_V_read;
    sc_signal< sc_lv<8> > grp_Filter2D_fu_80_p_dst_data_stream_V_din;
    sc_signal< sc_logic > grp_Filter2D_fu_80_p_dst_data_stream_V_write;
    sc_signal< sc_logic > grp_Filter2D_fu_80_ap_start_reg;
    ...
    void thread_grp_Filter2D_fu_80_ap_start();
