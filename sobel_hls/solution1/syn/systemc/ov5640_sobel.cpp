...
const int ov5640_sobel::C_S_AXI_DATA_WIDTH = "100000";
const int ov5640_sobel::C_S_AXI_WSTRB_WIDTH = "100";
const int ov5640_sobel::C_S_AXI_ADDR_WIDTH = "100000";
const sc_logic ov5640_sobel::ap_const_logic_1 = sc_dt::Log_1;
const sc_lv<24> ov5640_sobel::ap_const_lv24_0 = "000000000000000000000000";
const sc_lv<3> ov5640_sobel::ap_const_lv3_0 = "000";
const sc_lv<1> ov5640_sobel::ap_const_lv1_0 = "0";
const sc_logic ov5640_sobel::ap_const_logic_0 = sc_dt::Log_0;

ov5640_sobel::ov5640_sobel(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ov5640_sobel_AXILiteS_s_axi_U = new ov5640_sobel_AXILiteS_s_axi<C_S_AXI_AXILITES_ADDR_WIDTH,C_S_AXI_AXILITES_DATA_WIDTH>("ov5640_sobel_AXILiteS_s_axi_U");
    ov5640_sobel_AXILiteS_s_axi_U->AWVALID(s_axi_AXILiteS_AWVALID);
    ov5640_sobel_AXILiteS_s_axi_U->AWREADY(s_axi_AXILiteS_AWREADY);
    ov5640_sobel_AXILiteS_s_axi_U->AWADDR(s_axi_AXILiteS_AWADDR);
    ov5640_sobel_AXILiteS_s_axi_U->WVALID(s_axi_AXILiteS_WVALID);
    ov5640_sobel_AXILiteS_s_axi_U->WREADY(s_axi_AXILiteS_WREADY);
    ov5640_sobel_AXILiteS_s_axi_U->WDATA(s_axi_AXILiteS_WDATA);
    ov5640_sobel_AXILiteS_s_axi_U->WSTRB(s_axi_AXILiteS_WSTRB);
    ov5640_sobel_AXILiteS_s_axi_U->ARVALID(s_axi_AXILiteS_ARVALID);
    ov5640_sobel_AXILiteS_s_axi_U->ARREADY(s_axi_AXILiteS_ARREADY);
    ov5640_sobel_AXILiteS_s_axi_U->ARADDR(s_axi_AXILiteS_ARADDR);
    ov5640_sobel_AXILiteS_s_axi_U->RVALID(s_axi_AXILiteS_RVALID);
    ov5640_sobel_AXILiteS_s_axi_U->RREADY(s_axi_AXILiteS_RREADY);
    ov5640_sobel_AXILiteS_s_axi_U->RDATA(s_axi_AXILiteS_RDATA);
    ov5640_sobel_AXILiteS_s_axi_U->RRESP(s_axi_AXILiteS_RRESP);
    ov5640_sobel_AXILiteS_s_axi_U->BVALID(s_axi_AXILiteS_BVALID);
    ov5640_sobel_AXILiteS_s_axi_U->BREADY(s_axi_AXILiteS_BREADY);
    ov5640_sobel_AXILiteS_s_axi_U->BRESP(s_axi_AXILiteS_BRESP);
    ov5640_sobel_AXILiteS_s_axi_U->ACLK(ap_clk);
    ov5640_sobel_AXILiteS_s_axi_U->ARESET(ap_rst_n_inv);
    ov5640_sobel_AXILiteS_s_axi_U->ACLK_EN(ap_var_for_const0);
    ov5640_sobel_AXILiteS_s_axi_U->rows(rows);
    ov5640_sobel_AXILiteS_s_axi_U->cols(cols);
    ...
    AXIvideo2Mat_U0->img_rows_V_out_full_n(img_0_rows_V_c21_full_n);
    ...
    AXIvideo2Mat_U0->img_cols_V_out_full_n(img_0_cols_V_c22_full_n);
    ...
    CvtColor_U0->p_src_rows_V_dout(img_0_rows_V_c21_dout);
    CvtColor_U0->p_src_rows_V_empty_n(img_0_rows_V_c21_empty_n);
    CvtColor_U0->p_src_rows_V_read(CvtColor_U0_p_src_rows_V_read);
    CvtColor_U0->p_src_cols_V_dout(img_0_cols_V_c22_dout);
    CvtColor_U0->p_src_cols_V_empty_n(img_0_cols_V_c22_empty_n);
    ...
    Sobel_U0->p_src_rows_V_dout(img_1_rows_V_c_dout);
    Sobel_U0->p_src_rows_V_empty_n(img_1_rows_V_c_empty_n);
    Sobel_U0->p_src_rows_V_read(Sobel_U0_p_src_rows_V_read);
    Sobel_U0->p_src_cols_V_dout(img_1_cols_V_c_dout);
    Sobel_U0->p_src_cols_V_empty_n(img_1_cols_V_c_empty_n);
    Sobel_U0->p_src_cols_V_read(Sobel_U0_p_src_cols_V_read);
    Sobel_U0->p_src_data_stream_V_dout(img_1_data_stream_0_dout);
    Sobel_U0->p_src_data_stream_V_empty_n(img_1_data_stream_0_empty_n);
    ...
    Sobel_U0->p_dst_data_stream_V_full_n(img_2_data_stream_0_full_n);
    ...
    img_1_rows_V_c_U->if_read(Sobel_U0_p_src_rows_V_read);
    ...
    img_1_cols_V_c_U->if_read(Sobel_U0_p_src_cols_V_read);
    ...
    img_0_rows_V_c21_U = new fifo_w32_d2_A("img_0_rows_V_c21_U");
    img_0_rows_V_c21_U->clk(ap_clk);
    img_0_rows_V_c21_U->reset(ap_rst_n_inv);
    img_0_rows_V_c21_U->if_read_ce(ap_var_for_const0);
    img_0_rows_V_c21_U->if_write_ce(ap_var_for_const0);
    img_0_rows_V_c21_U->if_din(AXIvideo2Mat_U0_img_rows_V_out_din);
    img_0_rows_V_c21_U->if_full_n(img_0_rows_V_c21_full_n);
    img_0_rows_V_c21_U->if_write(AXIvideo2Mat_U0_img_rows_V_out_write);
    img_0_rows_V_c21_U->if_dout(img_0_rows_V_c21_dout);
    img_0_rows_V_c21_U->if_empty_n(img_0_rows_V_c21_empty_n);
    img_0_rows_V_c21_U->if_read(CvtColor_U0_p_src_rows_V_read);
    img_0_cols_V_c22_U = new fifo_w32_d2_A("img_0_cols_V_c22_U");
    img_0_cols_V_c22_U->clk(ap_clk);
    img_0_cols_V_c22_U->reset(ap_rst_n_inv);
    img_0_cols_V_c22_U->if_read_ce(ap_var_for_const0);
    img_0_cols_V_c22_U->if_write_ce(ap_var_for_const0);
    img_0_cols_V_c22_U->if_din(AXIvideo2Mat_U0_img_cols_V_out_din);
    img_0_cols_V_c22_U->if_full_n(img_0_cols_V_c22_full_n);
    img_0_cols_V_c22_U->if_write(AXIvideo2Mat_U0_img_cols_V_out_write);
    img_0_cols_V_c22_U->if_dout(img_0_cols_V_c22_dout);
    img_0_cols_V_c22_U->if_empty_n(img_0_cols_V_c22_empty_n);
    img_0_cols_V_c22_U->if_read(CvtColor_U0_p_src_cols_V_read);
    ...
    img_1_data_stream_0_U->if_read(Sobel_U0_p_src_data_stream_V_read);
    ...
    img_2_data_stream_0_U->if_din(Sobel_U0_p_dst_data_stream_V_din);
    img_2_data_stream_0_U->if_full_n(img_2_data_stream_0_full_n);
    img_2_data_stream_0_U->if_write(Sobel_U0_p_dst_data_stream_V_write);
    ...
    start_for_Sobel_U0_U->if_write(Block_Mat_exit49_pro_U0_start_write);
    ...
    start_for_CvtColoibs_U->if_write(Block_Mat_exit49_pro_U0_start_write);
    ...
    start_for_Mat2AXIjbC_U->if_write(Block_Mat_exit49_pro_U0_start_write);
    ...
    start_for_CvtColokbM_U = new start_for_CvtColokbM("start_for_CvtColokbM_U");
    start_for_CvtColokbM_U->clk(ap_clk);
    start_for_CvtColokbM_U->reset(ap_rst_n_inv);
    start_for_CvtColokbM_U->if_read_ce(ap_var_for_const0);
    start_for_CvtColokbM_U->if_write_ce(ap_var_for_const0);
    start_for_CvtColokbM_U->if_din(start_for_CvtColor_U0_din);
    start_for_CvtColokbM_U->if_full_n(start_for_CvtColor_U0_full_n);
    start_for_CvtColokbM_U->if_write(AXIvideo2Mat_U0_start_write);
    start_for_CvtColokbM_U->if_dout(start_for_CvtColor_U0_dout);
    start_for_CvtColokbM_U->if_empty_n(start_for_CvtColor_U0_empty_n);
    start_for_CvtColokbM_U->if_read(CvtColor_U0_ap_ready);
    ...
    apTFilenSS << "ov5640_sobel_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, img_0_rows_V_c21_full_n, "img_0_rows_V_c21_full_n");
    sc_trace(mVcdFile, img_0_rows_V_c21_dout, "img_0_rows_V_c21_dout");
    sc_trace(mVcdFile, img_0_rows_V_c21_empty_n, "img_0_rows_V_c21_empty_n");
    sc_trace(mVcdFile, img_0_cols_V_c22_full_n, "img_0_cols_V_c22_full_n");
    sc_trace(mVcdFile, img_0_cols_V_c22_dout, "img_0_cols_V_c22_dout");
    sc_trace(mVcdFile, img_0_cols_V_c22_empty_n, "img_0_cols_V_c22_empty_n");
    ...
    mHdltvinHandle.open("ov5640_sobel.hdltvin.dat");
    mHdltvoutHandle.open("ov5640_sobel.hdltvout.dat");
}

ov5640_sobel::~ov5640_sobel() {
    if (mVcdFile) 
    ...
    delete ov5640_sobel_AXILiteS_s_axi_U;
    ...
    delete img_0_rows_V_c21_U;
    delete img_0_cols_V_c22_U;
    ...
    delete start_for_CvtColokbM_U;
}

void ov5640_sobel::thread_ap_var_for_const0() {
    ap_var_for_const0 = ap_const_logic_1;
}

void ov5640_sobel::thread_AXIvideo2Mat_U0_ap_continue() {
    AXIvideo2Mat_U0_ap_continue = ap_const_logic_1;
}

void ov5640_sobel::thread_AXIvideo2Mat_U0_ap_start() {
    AXIvideo2Mat_U0_ap_start = ap_const_logic_1;
}

void ov5640_sobel::thread_Block_Mat_exit49_pro_U0_ap_continue() {
    Block_Mat_exit49_pro_U0_ap_continue = ap_const_logic_1;
}

void ov5640_sobel::thread_Block_Mat_exit49_pro_U0_ap_start() {
    Block_Mat_exit49_pro_U0_ap_start = ap_const_logic_1;
}

void ov5640_sobel::thread_Block_Mat_exit49_pro_U0_start_full_n() {
    Block_Mat_exit49_pro_U0_start_full_n = (start_for_Sobel_U0_full_n.read() & start_for_CvtColor_1_U0_full_n.read() & start_for_Mat2AXIvideo_U0_full_n.read());
}

void ov5640_sobel::thread_CvtColor_1_U0_ap_continue() {
    CvtColor_1_U0_ap_continue = ap_const_logic_1;
}

void ov5640_sobel::thread_CvtColor_1_U0_ap_start() {
    CvtColor_1_U0_ap_start = start_for_CvtColor_1_U0_empty_n.read();
}

void ov5640_sobel::thread_CvtColor_1_U0_start_full_n() {
    CvtColor_1_U0_start_full_n = ap_const_logic_1;
}

void ov5640_sobel::thread_CvtColor_1_U0_start_write() {
    CvtColor_1_U0_start_write = ap_const_logic_0;
}

void ov5640_sobel::thread_CvtColor_U0_ap_continue() {
    CvtColor_U0_ap_continue = ap_const_logic_1;
}

void ov5640_sobel::thread_CvtColor_U0_ap_start() {
    CvtColor_U0_ap_start = start_for_CvtColor_U0_empty_n.read();
}

void ov5640_sobel::thread_CvtColor_U0_start_full_n() {
    CvtColor_U0_start_full_n = ap_const_logic_1;
}

void ov5640_sobel::thread_CvtColor_U0_start_write() {
    CvtColor_U0_start_write = ap_const_logic_0;
}

void ov5640_sobel::thread_INPUT_STREAM_TREADY() {
    INPUT_STREAM_TREADY = AXIvideo2Mat_U0_INPUT_STREAM_TREADY.read();
}

void ov5640_sobel::thread_Mat2AXIvideo_U0_ap_continue() {
    Mat2AXIvideo_U0_ap_continue = ap_const_logic_1;
}

void ov5640_sobel::thread_Mat2AXIvideo_U0_ap_start() {
    Mat2AXIvideo_U0_ap_start = start_for_Mat2AXIvideo_U0_empty_n.read();
}

void ov5640_sobel::thread_Mat2AXIvideo_U0_start_full_n() {
    Mat2AXIvideo_U0_start_full_n = ap_const_logic_1;
}

void ov5640_sobel::thread_Mat2AXIvideo_U0_start_write() {
    Mat2AXIvideo_U0_start_write = ap_const_logic_0;
}

void ov5640_sobel::thread_OUTPUT_STREAM_TDATA() {
    OUTPUT_STREAM_TDATA = Mat2AXIvideo_U0_OUTPUT_STREAM_TDATA.read();
}

void ov5640_sobel::thread_OUTPUT_STREAM_TDEST() {
    OUTPUT_STREAM_TDEST = Mat2AXIvideo_U0_OUTPUT_STREAM_TDEST.read();
}

void ov5640_sobel::thread_OUTPUT_STREAM_TID() {
    OUTPUT_STREAM_TID = Mat2AXIvideo_U0_OUTPUT_STREAM_TID.read();
}

void ov5640_sobel::thread_OUTPUT_STREAM_TKEEP() {
    OUTPUT_STREAM_TKEEP = Mat2AXIvideo_U0_OUTPUT_STREAM_TKEEP.read();
}

void ov5640_sobel::thread_OUTPUT_STREAM_TLAST() {
    OUTPUT_STREAM_TLAST = Mat2AXIvideo_U0_OUTPUT_STREAM_TLAST.read();
}

void ov5640_sobel::thread_OUTPUT_STREAM_TSTRB() {
    OUTPUT_STREAM_TSTRB = Mat2AXIvideo_U0_OUTPUT_STREAM_TSTRB.read();
}

void ov5640_sobel::thread_OUTPUT_STREAM_TUSER() {
    OUTPUT_STREAM_TUSER = Mat2AXIvideo_U0_OUTPUT_STREAM_TUSER.read();
}

void ov5640_sobel::thread_OUTPUT_STREAM_TVALID() {
    OUTPUT_STREAM_TVALID = Mat2AXIvideo_U0_OUTPUT_STREAM_TVALID.read();
}

void ov5640_sobel::thread_Sobel_U0_ap_continue() {
    Sobel_U0_ap_continue = ap_const_logic_1;
}

void ov5640_sobel::thread_Sobel_U0_ap_start() {
    Sobel_U0_ap_start = start_for_Sobel_U0_empty_n.read();
}

void ov5640_sobel::thread_Sobel_U0_start_full_n() {
    Sobel_U0_start_full_n = ap_const_logic_1;
}

void ov5640_sobel::thread_Sobel_U0_start_write() {
    Sobel_U0_start_write = ap_const_logic_0;
}

void ov5640_sobel::thread_ap_rst_n_inv() {
    ap_rst_n_inv =  (sc_logic) (~ap_rst_n.read());
}

void ov5640_sobel::thread_ap_sync_continue() {
    ap_sync_continue = ap_const_logic_0;
}

void ov5640_sobel::thread_start_for_CvtColor_1_U0_din() {
    start_for_CvtColor_1_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void ov5640_sobel::thread_start_for_CvtColor_U0_din() {
    start_for_CvtColor_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void ov5640_sobel::thread_start_for_Mat2AXIvideo_U0_din() {
    start_for_Mat2AXIvideo_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void ov5640_sobel::thread_start_for_Sobel_U0_din() {
    start_for_Sobel_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void ov5640_sobel::thread_hdltv_gen() {
