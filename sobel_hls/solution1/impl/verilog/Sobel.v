...
reg   [31:0] p_src_rows_V_read_reg_92;
reg    ap_block_state1;
reg   [31:0] p_src_cols_V_read_reg_97;
wire    grp_Filter2D_fu_80_ap_start;
wire    grp_Filter2D_fu_80_ap_done;
wire    grp_Filter2D_fu_80_ap_idle;
wire    grp_Filter2D_fu_80_ap_ready;
wire    grp_Filter2D_fu_80_p_src_data_stream_V_read;
wire   [7:0] grp_Filter2D_fu_80_p_dst_data_stream_V_din;
wire    grp_Filter2D_fu_80_p_dst_data_stream_V_write;
reg    grp_Filter2D_fu_80_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 2'd1;
#0 grp_Filter2D_fu_80_ap_start_reg = 1'b0;
end

Filter2D grp_Filter2D_fu_80(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((grp_Filter2D_fu_80_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_Filter2D_fu_80_ap_start_reg <= 1'b0;
    end else begin
        if ((~((ap_start == 1'b0) | (p_src_cols_V_empty_n == 1'b0) | (p_src_rows_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_Filter2D_fu_80_ap_start_reg <= 1'b1;
        end else if ((grp_Filter2D_fu_80_ap_ready == 1'b1)) begin
            grp_Filter2D_fu_80_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if (((grp_Filter2D_fu_80_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign grp_Filter2D_fu_80_ap_start = grp_Filter2D_fu_80_ap_start_reg;

assign p_dst_data_stream_V_din = grp_Filter2D_fu_80_p_dst_data_stream_V_din;
