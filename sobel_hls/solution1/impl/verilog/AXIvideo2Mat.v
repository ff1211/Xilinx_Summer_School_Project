...
wire   [0:0] exitcond_i_fu_408_p2;
wire   [0:0] brmerge_i_fu_422_p2;
...
reg   [0:0] exitcond_i_reg_496;
reg    img_data_stream_1_V_blk_n;
reg    img_data_stream_2_V_blk_n;
reg    img_rows_V_out_blk_n;
reg    img_cols_V_out_blk_n;
reg   [0:0] eol_reg_274;
reg   [23:0] axi_data_V_1_i_reg_285;
reg   [31:0] t_V_3_reg_296;
reg   [0:0] eol_i_reg_307;
reg   [0:0] axi_last_V_2_i_reg_319;
reg   [23:0] p_Val2_s_reg_332;
reg   [31:0] rows_V_reg_457;
reg    ap_block_state1;
reg   [31:0] cols_V_reg_462;
reg   [23:0] tmp_data_V_reg_467;
reg   [0:0] tmp_last_V_reg_475;
wire   [0:0] exitcond5_i_fu_397_p2;
wire    ap_CS_fsm_state4;
wire   [31:0] i_V_fu_402_p2;
reg   [31:0] i_V_reg_491;
reg    ap_predicate_op65_read_state5;
reg    ap_block_state5_pp1_stage0_iter0;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [31:0] j_V_fu_413_p2;
wire   [7:0] tmp_fu_428_p1;
reg   [7:0] tmp_reg_509;
reg   [7:0] tmp_26_reg_514;
reg   [7:0] tmp_27_reg_519;
reg    ap_block_state8;
reg    ap_block_pp1_stage0_subdone;
reg    ap_condition_pp1_exit_iter0_state5;
reg   [0:0] axi_last_V_3_i_reg_344;
reg   [0:0] axi_last_V1_i_reg_243;
wire    ap_CS_fsm_state9;
wire    ap_CS_fsm_state3;
reg   [23:0] axi_data_V_3_i_reg_356;
reg   [23:0] axi_data_V1_i_reg_253;
reg   [31:0] t_V_reg_263;
reg   [0:0] ap_phi_mux_eol_phi_fu_277_p4;
reg   [23:0] ap_phi_mux_axi_data_V_1_i_phi_fu_288_p4;
reg   [0:0] ap_phi_mux_eol_i_phi_fu_311_p4;
wire   [0:0] ap_phi_reg_pp1_iter0_axi_last_V_2_i_reg_319;
reg   [23:0] ap_phi_mux_p_Val2_s_phi_fu_336_p4;
wire   [23:0] ap_phi_reg_pp1_iter0_p_Val2_s_reg_332;
wire    ap_CS_fsm_state7;
reg   [0:0] eol_2_i_reg_368;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_i_fu_172;
wire   [0:0] tmp_user_V_fu_388_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond5_i_fu_397_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state5) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond5_i_fu_397_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_496 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((eol_2_i_reg_368 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_i_reg_368 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_598)) begin
        if (((brmerge_i_fu_422_p2 == 1'd1) & (exitcond_i_fu_408_p2 == 1'd0))) begin
            axi_last_V_2_i_reg_319 <= ap_phi_mux_eol_phi_fu_277_p4;
        end else if (((brmerge_i_fu_422_p2 == 1'd0) & (exitcond_i_fu_408_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_408_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_i_fu_172 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_408_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        tmp_26_reg_514 <= {{ap_phi_mux_p_Val2_s_phi_fu_336_p4[15:8]}};
        tmp_27_reg_519 <= {{ap_phi_mux_p_Val2_s_phi_fu_336_p4[23:16]}};
...
always @ (*) begin
    if (((~((eol_2_i_reg_368 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_i_reg_368 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op65_read_state5 == 1'b1)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_368 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((brmerge_i_fu_422_p2 == 1'd0) & (exitcond_i_fu_408_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if ((exitcond_i_fu_408_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond5_i_fu_397_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((exitcond_i_reg_496 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_676)) begin
        if ((brmerge_i_fu_422_p2 == 1'd1)) begin
            ap_phi_mux_p_Val2_s_phi_fu_336_p4 = ap_phi_mux_axi_data_V_1_i_phi_fu_288_p4;
        end else if ((brmerge_i_fu_422_p2 == 1'd0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_388_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_388_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((exitcond_i_fu_408_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((exitcond_i_fu_408_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        ...
        ap_ST_fsm_state8 : begin
            if ((~((eol_2_i_reg_368 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (eol_2_i_reg_368 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else if ((~((eol_2_i_reg_368 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out)) & (ap_phi_mux_eol_2_i_phi_fu_371_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_i_reg_496 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_496 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_496 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)))) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_predicate_op65_read_state5 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_i_reg_496 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_496 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_496 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)))) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_predicate_op65_read_state5 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_i_reg_496 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_496 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_496 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)))) | ((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_predicate_op65_read_state5 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((exitcond_i_reg_496 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_496 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_496 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_state8 = ((eol_2_i_reg_368 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end
...
always @ (*) begin
    ap_condition_676 = ((exitcond_i_fu_408_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
always @ (*) begin
    ap_predicate_op65_read_state5 = ((brmerge_i_fu_422_p2 == 1'd0) & (exitcond_i_fu_408_p2 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_i_fu_422_p2 = (sof_1_i_fu_172 | ap_phi_mux_eol_i_phi_fu_311_p4);

assign exitcond5_i_fu_397_p2 = ((t_V_reg_263 == rows_V_reg_457) ? 1'b1 : 1'b0);

assign exitcond_i_fu_408_p2 = ((t_V_3_reg_296 == cols_V_reg_462) ? 1'b1 : 1'b0);

assign i_V_fu_402_p2 = (t_V_reg_263 + 32'd1);

assign img_cols_V_out_din = img_cols_V_dout;

assign img_data_stream_0_V_din = tmp_reg_509;

assign img_data_stream_1_V_din = tmp_26_reg_514;

assign img_data_stream_2_V_din = tmp_27_reg_519;

assign img_rows_V_out_din = img_rows_V_dout;

assign j_V_fu_413_p2 = (t_V_3_reg_296 + 32'd1);

assign start_out = real_start;

assign tmp_fu_428_p1 = ap_phi_mux_p_Val2_s_phi_fu_336_p4[7:0];

assign tmp_user_V_fu_388_p1 = AXI_video_strm_V_user_V_0_data_out;
