...
entity ov5640_otsu_threshold is
generic (
...
architecture behav of ov5640_otsu_threshold is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "ov5640_otsu_threshold,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.386000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=2,HLS_SYN_DSP=17,HLS_SYN_FF=7073,HLS_SYN_LUT=11911,HLS_VERSION=2018_3}";
    ...
    signal Threshold_U0_p_src_rows_V_read : STD_LOGIC;
    signal Threshold_U0_p_src_cols_V_read : STD_LOGIC;
    ...
    component start_for_Threshomb6 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component ov5640_otsu_threshold_AXILiteS_s_axi IS
    generic (
...
begin
    ov5640_otsu_threshold_AXILiteS_s_axi_U : component ov5640_otsu_threshold_AXILiteS_s_axi
    generic map (
    ...
    port map (
        ...
        p_src_rows_V_read => Threshold_U0_p_src_rows_V_read,
        p_src_cols_V_dout => img_1_cols_V_c_dout,
        p_src_cols_V_empty_n => img_1_cols_V_c_empty_n,
        p_src_cols_V_read => Threshold_U0_p_src_cols_V_read,
    ...
    port map (
        ...
        if_read => Threshold_U0_p_src_rows_V_read);
    ...
    port map (
        ...
        if_read => Threshold_U0_p_src_cols_V_read);
    ...
    start_for_Threshomb6_U : component start_for_Threshomb6
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    Block_Mat_exit49_pro_U0_start_full_n <= (start_for_Threshold_U0_full_n and start_for_Mat2AXIvideo_U0_full_n and start_for_CvtColor_1_U0_full_n);
