...
// ==============================================================
#ifndef __ov5640_otsu_thresfYi__HH__
#define __ov5640_otsu_thresfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ov5640_otsu_thresfYi) {
    ...
    SC_CTOR(ov5640_otsu_thresfYi):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
