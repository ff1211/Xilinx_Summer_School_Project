...
// ==============================================================
#ifndef __ov5640_otsu_threscud__HH__
#define __ov5640_otsu_threscud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ov5640_otsu_threscud) {
    ...
    SC_CTOR(ov5640_otsu_threscud):  simcore_mac_0_U ("simcore_mac_0_U") {
