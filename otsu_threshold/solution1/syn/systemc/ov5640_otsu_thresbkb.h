...
// ==============================================================
#ifndef __ov5640_otsu_thresbkb__HH__
#define __ov5640_otsu_thresbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ov5640_otsu_thresbkb) {
    ...
    SC_CTOR(ov5640_otsu_thresbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
