...
// ==============================================================
#ifndef __ov5640_otsu_thresdEe__HH__
#define __ov5640_otsu_thresdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ov5640_otsu_thresdEe) {
    ...
    SC_CTOR(ov5640_otsu_thresdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
