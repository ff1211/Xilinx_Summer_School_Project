...
// ==============================================================
#ifndef __ov5640_otsu_threskbM__HH__
#define __ov5640_otsu_threskbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ov5640_otsu_threskbM) {
    ...
    SC_CTOR(ov5640_otsu_threskbM):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
