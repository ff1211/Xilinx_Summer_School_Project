...
// ==============================================================
#ifndef __ov5640_otsu_thresibs__HH__
#define __ov5640_otsu_thresibs__HH__
#include "ACMP_fdiv.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ov5640_otsu_thresibs) {
    ...
    SC_CTOR(ov5640_otsu_thresibs):  ACMP_fdiv_U ("ACMP_fdiv_U") {
        ACMP_fdiv_U.clk(clk);
