...
#ifndef _ov5640_otsu_threshold_HH_
#define _ov5640_otsu_threshold_HH_
...
#include "start_for_Threshomb6.h"
#include "start_for_CvtColoncg.h"
#include "start_for_Mat2AXIocq.h"
#include "start_for_CvtColopcA.h"
#include "ov5640_otsu_threshold_AXILiteS_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_AXILITES_ADDR_WIDTH = 5,
         unsigned int C_S_AXI_AXILITES_DATA_WIDTH = 32>
struct ov5640_otsu_threshold : public sc_module {
    ...
    // Module declarations
    ov5640_otsu_threshold(sc_module_name name);
    SC_HAS_PROCESS(ov5640_otsu_threshold);
    ...
    ov5640_otsu_threshold_AXILiteS_s_axi<C_S_AXI_AXILITES_ADDR_WIDTH,C_S_AXI_AXILITES_DATA_WIDTH>* ov5640_otsu_threshold_AXILiteS_s_axi_U;
    ...
    start_for_Threshomb6* start_for_Threshomb6_U;
    ...
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_ap_start;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_start_full_n;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_ap_done;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_ap_continue;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_ap_idle;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_ap_ready;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_start_out;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_start_write;
    sc_signal< sc_lv<32> > Block_Mat_exit49_pro_U0_img_0_rows_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_img_0_rows_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit49_pro_U0_img_0_cols_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_img_0_cols_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit49_pro_U0_img_1_rows_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_img_1_rows_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit49_pro_U0_img_1_cols_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_img_1_cols_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit49_pro_U0_img_2_rows_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_img_2_rows_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit49_pro_U0_img_2_cols_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_img_2_cols_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit49_pro_U0_img_3_rows_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_img_3_rows_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit49_pro_U0_img_3_cols_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit49_pro_U0_img_3_cols_V_out_write;
    ...
    sc_signal< sc_logic > Threshold_U0_p_src_rows_V_read;
    sc_signal< sc_logic > Threshold_U0_p_src_cols_V_read;
    sc_signal< sc_logic > Threshold_U0_p_src_data_stream_V_read;
    sc_signal< sc_lv<8> > Threshold_U0_p_dst_data_stream_V_din;
    sc_signal< sc_logic > Threshold_U0_p_dst_data_stream_V_write;
    ...
    void thread_Block_Mat_exit49_pro_U0_ap_continue();
    void thread_Block_Mat_exit49_pro_U0_ap_start();
    void thread_Block_Mat_exit49_pro_U0_start_full_n();
