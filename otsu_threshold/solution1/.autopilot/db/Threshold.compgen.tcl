...
set out_width 29
set exp i0*i1
set arg_lists {i0 {20 0 +} i1 {9 0 +} p {29 0 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 60
set hasByteEnable 0
set MemName Threshold_hist_oueOg
