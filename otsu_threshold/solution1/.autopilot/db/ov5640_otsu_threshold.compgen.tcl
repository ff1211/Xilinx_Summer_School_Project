...
set ID 99
set FifoName fifo_w8_d2_A
set InstName img_3_data_stream_1_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 100
set FifoName fifo_w8_d2_A
set InstName img_3_data_stream_2_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 101
set FifoName start_for_Threshomb6
set InstName start_for_Threshomb6_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 102
set FifoName start_for_CvtColoncg
set InstName start_for_CvtColoncg_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 105 \
			corename ov5640_otsu_threshold_AXILiteS_axilite \
			name ov5640_otsu_threshold_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ov5640_otsu_threshold_AXILiteS_s_axi
}
