# 1 "qrc_decoder/src/blocks.c"
# 1 "qrc_decoder/src/blocks.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "qrc_decoder/src/blocks.c" 2
# 19 "qrc_decoder/src/blocks.c"
# 1 "qrc_decoder/src/blocks.h" 1
# 22 "qrc_decoder/src/blocks.h"
...
# 23 "qrc_decoder/src/blocks.h" 2

unsigned int get_bits(scanner_t* scanner, size_t n);
# 20 "qrc_decoder/src/blocks.c" 2
...
# 101 "C:/yueqihong/MYSOFTWARE/Xilinx/Vivado/2018.3/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\stdio.h" 3
...
# 26 "qrc_decoder/src/blocks.c" 2
# 1 "qrc_decoder/src/modules.h" 1
# 24 "qrc_decoder/src/modules.h"
...
# 27 "qrc_decoder/src/blocks.c" 2
# 1 "qrc_decoder/src/rs.h" 1
# 24 "qrc_decoder/src/rs.h"
...
# 99 "qrc_decoder/src/blocks.c"
 size_t n_errwords = b[1] - b[2];
 for ( i = 0; i < n_errwords; i++)
 {
  skip_bits(scanner, cur * 8);
  scanner->block_data[n_data+i] = get_codeword(scanner);
  skip_bits(scanner, (nblocks-cur-1) * 8);
 }
# 115 "qrc_decoder/src/blocks.c"
