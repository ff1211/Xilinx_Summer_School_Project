...
// ==============================================================
#ifndef __ov5640_rgb2gray_mdEe__HH__
#define __ov5640_rgb2gray_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ov5640_rgb2gray_mdEe) {
    ...
    SC_CTOR(ov5640_rgb2gray_mdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
