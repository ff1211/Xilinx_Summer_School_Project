...
// ==============================================================
#ifndef __ov5640_rgb2gray_mbkb__HH__
#define __ov5640_rgb2gray_mbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ov5640_rgb2gray_mbkb) {
    ...
    SC_CTOR(ov5640_rgb2gray_mbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
