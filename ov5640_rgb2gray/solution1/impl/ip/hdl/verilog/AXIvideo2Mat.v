...
wire   [0:0] exitcond2_i_fu_397_p2;
...
reg   [7:0] tmp_reg_509;
reg   [7:0] tmp_5_reg_514;
reg   [7:0] tmp_6_reg_519;
reg    ap_block_state8;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond2_i_fu_397_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state5) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond2_i_fu_397_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_408_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        tmp_5_reg_514 <= {{ap_phi_mux_p_Val2_s_phi_fu_336_p4[15:8]}};
        tmp_6_reg_519 <= {{ap_phi_mux_p_Val2_s_phi_fu_336_p4[23:16]}};
...
always @ (*) begin
    if (((exitcond2_i_fu_397_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign exitcond2_i_fu_397_p2 = ((t_V_reg_263 == rows_V_reg_457) ? 1'b1 : 1'b0);

assign exitcond_i_fu_408_p2 = ((t_V_2_reg_296 == cols_V_reg_462) ? 1'b1 : 1'b0);
...
assign img_data_stream_1_V_din = tmp_5_reg_514;

assign img_data_stream_2_V_din = tmp_6_reg_519;

assign img_rows_V_out_din = img_rows_V_dout;

assign j_V_fu_413_p2 = (t_V_2_reg_296 + 32'd1);
