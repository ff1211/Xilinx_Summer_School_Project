...
// ==============================================================
#ifndef __ov5640_rgb2gray_mcud__HH__
#define __ov5640_rgb2gray_mcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ov5640_rgb2gray_mcud) {
    ...
    SC_CTOR(ov5640_rgb2gray_mcud):  simcore_mac_0_U ("simcore_mac_0_U") {
