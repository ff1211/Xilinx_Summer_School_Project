...
Mat2AXIvideo::Mat2AXIvideo(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( tmp_3_cast_i_fu_266_p1 );
    ...
    SC_METHOD(thread_tmp_3_cast_i_fu_266_p1);
    sensitive << ( t_V_1_reg_218 );
    ...
    sc_trace(mVcdFile, tmp_3_cast_i_fu_266_p1, "tmp_3_cast_i_fu_266_p1");
...
void Mat2AXIvideo::thread_axi_last_V_fu_270_p2() {
    axi_last_V_fu_270_p2 = (!tmp_3_cast_i_fu_266_p1.read().is_01() || !ret_V_reg_312.read().is_01())? sc_lv<1>(): sc_lv<1>(tmp_3_cast_i_fu_266_p1.read() == ret_V_reg_312.read());
}
...
void Mat2AXIvideo::thread_tmp_3_cast_i_fu_266_p1() {
    tmp_3_cast_i_fu_266_p1 = esl_zext<33,32>(t_V_1_reg_218.read());
}
